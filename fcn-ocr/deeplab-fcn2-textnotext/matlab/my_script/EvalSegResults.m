...
VOC_root_folder = '../../data/VOCdevkit/VOC2012';
...
output_mat_folder = fullfile('E:/hwang/deeplab-fcn2-textnotext', dataset, feature_name, model_name, testset, feature_type);

save_root_folder = fullfile('E:/hwang/deeplab-fcn2-textnotext', dataset, feature_name, model_name, testset, feature_type, post_folder);
