...
%BUILD%\convert_imageset.cpp --resize_height=%RESIZE_HEIGHT% --resize_width=%RESIZE_WIDTH% --shuffle --gray %TRAIN_DATA_ROOT% %EXAMPLE%\classifier_train_list.txt %EXAMPLE%\ocr_recog_train_lmdb

echo "Creating val lmdb..."

set GLOG_logtostderr=1 
%BUILD%\convert_imageset.cpp --resize_height=%RESIZE_HEIGHT% --resize_width=%RESIZE_WIDTH% --shuffle --gray %VAL_DATA_ROOT% %EXAMPLE%\classifier_test_list.txt %EXAMPLE%\ocr_recog_test_lmdb
