...
def nms_average(boxes, overlapThresh=0.2):
    ...
    while len(idxs) > 0:
        ...
        for idx in delete_idxs:
        	...
        	if(boxes[idxs[idx]][1] < xmin):
        		xmin = boxes[idxs[idx]][1]
        	if(boxes[idxs[idx]][0] < ymin):
        		ymin = boxes[idxs[idx]][0]
        	if(boxes[idxs[idx]][3] > xmax):
        		xmax = boxes[idxs[idx]][3]
        	if(boxes[idxs[idx]][2] > ymax):
        		ymax = boxes[idxs[idx]][2]
        ...
        result_boxes.append([ymin, xmin, ymax, xmax, ave_prob / len(delete_idxs),boxes[0,5],boxes[0,6]])
