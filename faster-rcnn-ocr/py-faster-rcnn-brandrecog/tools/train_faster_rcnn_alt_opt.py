...
def train_fast_rcnn(queue=None, imdb_name=None, init_model=None, solver=None,
    ...
    imdb,roidb = combined_roidb(imdb_name, rpn_file=rpn_file)
    print 'roidb len: {}'.format(len(roidb))
...
if __name__ == '__main__':
    ...
    mp_kwargs = dict(
            ...
            rpn_model_path=str('E:/hwang/py-faster-rcnn-brandrecog/output/default/voc_2007_trainval/zf_rpn_iter_100.caffemodel'),
            cfg=cfg,
